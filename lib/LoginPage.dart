...
//      child: TextField(controller: editController,decoration: InputDecoration(hintText: "name"),),
          child:  Column(
            children: <Widget>[TextField(controller: editController,decoration: InputDecoration(hintText: "name"),),
            TextField(controller: passWDEditController,decoration: InputDecoration(hintText: "passwd"),),
            new Container(
